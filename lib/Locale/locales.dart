...
class AppLocalizations {
  ...
  String? get trainTicket {
    return _localizedValues[locale.languageCode]!['trainTicket'];
  }
  String? get flights {
    return _localizedValues[locale.languageCode]!['flights'];
  }
  String? get bus {
  ...
  String? get flight {
    return _localizedValues[locale.languageCode]!['flight'];
  }
  String? get dth {
...
class AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  bool isSupported(Locale locale) =>
      ['en', 'ar', 'fr', 'id', 'pt', 'es'].contains(locale.languageCode);
